...
class SRIssueNotificationEmail(Thread):
    ...
    def send_status_update_notification(self):
        ...
        self.msg = f"""
            ...
            {self.firstname} has updated issue '{self.issue.code}' status or assignee.
            ...
            Should you have any question, please contact the assigner ({self.firstname}).

            Thanks,
            Zigida Team,
            Email: {self.issue.assigned_to.email}
        """
